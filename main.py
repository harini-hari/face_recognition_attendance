...
window.configure(background='#003153')
...
message3 = tk.Label(window, text="Face Recognition Based Attendance Monitoring System" ,fg="white",bg="#4169e1" ,width=55 ,height=1,font=('comic', 29, ' bold '))
message3.place(x=10, y=10)

datef = tk.Label(window, text=day + "-" + mont[month] + "-" + year, fg="white", bg="#4169e1",
                 width=20, font=('comic', 15, ' bold '))
datef.pack(fill='both', expand=True)
datef.place(relx=0.30, rely=0.09)

clock = tk.Label(window, fg="white", bg="#4169e1", width=20, font=('comic', 15, ' bold '))
clock.place(relx=0.50, rely=0.09)
tick()

head2 = tk.Label(frame2, text="                       For New Registrations                       ", fg="black",bg="#4169e1" ,font=('comic', 17, ' bold ') )
head2.place(x=0,y=-5)

head1 = tk.Label(frame1, text="                       For Already Registered                       ", fg="black",bg="#4169e1" ,font=('comic', 17, ' bold ') )
head1.place(x=0,y=-5)

lbl = tk.Label(frame2, text="Enter ID",width=20  ,height=1  ,fg="black"  ,bg="#6495ED" ,font=('comic', 17, ' bold ') )
lbl.place(x=80, y=55)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('comic', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter Name",width=20  ,fg="black"  ,bg="#6495ED" ,font=('comic', 17, ' bold '))
lbl2.place(x=80, y=140)

txt2 = tk.Entry(frame2,width=32 ,fg="black",font=('comic', 15, ' bold ')  )
txt2.place(x=30, y=173)

message1 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Profile" ,bg="#6495ED" ,fg="black"  ,width=39 ,height=1, activebackground = "#3ffc00" ,font=('comic', 15, ' bold '))
message1.place(x=7, y=230)

message = tk.Label(frame2, text="" ,bg="#6495ED" ,fg="black"  ,width=39,height=1, activebackground = "#3ffc00" ,font=('comic', 16, ' bold '))
message.place(x=7, y=450)

lbl3 = tk.Label(frame1, text="Attendance",width=20  ,fg="black"  ,bg="#6495ED"  ,height=1 ,font=('comic', 15, ' bold '))
...
trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages  ,fg="black"  ,bg="#6495ED"  ,width=13  ,height=1, activebackground = "white" ,font=('comic', 12, ' bold '))
...
def send_email():
    ...
    from_email = "spyhunterad@gmail.com"  # Update with your email
    password = "qzgl ltcu axbf hvsq"  # Update with your email password
...
delete_registration_button = tk.Button(frame1, text="Delete Registration CSV", command=delete_registration_csv, fg="black", bg="#FAFAD2", width=19, font=('comic', 8, 'bold'))
delete_registration_button.place(x=5, y=85)

delete_attendance_button = tk.Button(frame1, text="Delete Attendance CSV", command=delete_attendance_csv, fg="black", bg="#FAFAD2", width=19, font=('comic', 8, 'bold'))
...
delete_images_button = tk.Button(frame1, text="Delete Registered Images", command=delete_registered_images, fg="black", bg="#FAFAD2", width=20, font=('comic', 8, 'bold'))
